...
BEGIN
  ...
  IF p_accepted THEN
    IF v_converted_job_id IS NULL THEN
      ...
      -- Use quote job_type first, then original job job_type, then fallback to Repair
