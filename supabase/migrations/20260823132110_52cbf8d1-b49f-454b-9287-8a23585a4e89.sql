ALTER TABLE public.profiles
  ADD COLUMN IF NOT EXISTS receives_ops_notifications boolean NOT NULL DEFAULT false;

UPDATE public.profiles
SET receives_ops_notifications = true
WHERE user_id = 'ed429061-7b76-4272-af4a-25249ee6d719';
