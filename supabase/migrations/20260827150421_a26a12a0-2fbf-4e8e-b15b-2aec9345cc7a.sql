-- Prevent duplicate office alerts for the same submitted parts request
CREATE UNIQUE INDEX IF NOT EXISTS notifications_parts_requested_once
  ON public.notifications (recipient_user_id, (metadata->>'parts_request_id'))
  WHERE notification_type = 'parts_requested';
