...
const VARIABLES = [
  { tag: "{customer_name}", desc: "Customer's first name" },
  { tag: "{date}", desc: "Next service due date" },
  { tag: "{phone}", desc: "Your WhatsApp number" },
...
const WhatsAppTemplates = ({ embedded = false }: { embedded?: boolean }) => {
  ...
  const [formType, setFormType] = useState("30 Day Reminder");
  ...
  const handleSave = async () => {
    if (!user || !formName.trim() || !formBody.trim()) {
      ...
      <div className="max-w-3xl mx-auto px-4 py-6 space-y-6">
        ...
        <Card>
          <CardContent className="p-4">
            <h3 className="text-sm font-bold mb-2">Available Variables</h3>
            <p className="text-xs text-muted-foreground mb-2">
              Use these in your templates — they'll be auto-filled when sending.
            </p>
          ...
          <Card>
            <CardContent className="p-5 space-y-4">
              <div className="flex items-center justify-between">
                <h3 className="font-bold text-base">{editId ? "Edit Template" : "New Template"}</h3>
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <p className={`text-xs ${formBody.length > 320 ? "text-warning" : "text-muted-foreground"}`}>
                    {formBody.length} / 320
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <Label htmlFor="is-default" className="text-xs">
                  Set as default template for this message type
                </Label>
              </div>
        ...
        {/* Template list */}
        <div className="flex items-center justify-between">
          <h2 className="font-bold text-base">Your Templates</h2>
          {!isEditing && (
          ...
          <Card className="border-dashed">
            <CardContent className="p-8 text-center space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Create your first template to speed up sending reminders and messages.
              </p>
              {!isEditing && (
                ...
                <CardContent className="p-4">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex gap-1 shrink-0">
                      <Button size="sm" variant="ghost" className="h-8 px-2" onClick={() => startEdit(t)}>
