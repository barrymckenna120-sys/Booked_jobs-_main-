...
export const generateImportTemplate = () => {
  ...
  const data: any[][] = [
    ...
    [
      "John Murphy", "087 123 4567", "john@example.com", "12 Main St, Swords", "K67 AB12", "01", "10001234567",
      "Side gate, key under mat",
      "Vaillant", "ecoTEC Plus", "Gas", "15/03/2019", "No", "10",
