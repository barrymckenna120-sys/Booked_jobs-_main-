...
export const generateImportTemplate = () => {
  ...
  const data: any[][] = [
    ...
    [
      ...
      "Access Notes",
      "Boiler Make / Model", "Boiler Type", "Installation Date", "Under Warranty",
  ...
  ws["!cols"] = [
    ...
    { wch: 22 }, // H - Boiler Make/Model
    { wch: 12 }, // I - Boiler Type
    { wch: 16 }, // J - Installation Date
    { wch: 14 }, // K - Under Warranty
    { wch: 16 }, // L - Last Service Date
    { wch: 20 }, // M - Last Service Engineer
    { wch: 28 }, // N - Engineer Notes
    { wch: 16 }, // O - Next Service Due
    { wch: 14 }, // P - Service Status
    { wch: 20 }, // Q - Assigned Engineer
    { wch: 32 }, // R - Customer Notes
    { wch: 16 }, // S - Customer Since
  ];
