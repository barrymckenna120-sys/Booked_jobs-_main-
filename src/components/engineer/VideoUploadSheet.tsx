...
import { CheckCircle2, AlertTriangle, RefreshCw, X, Send } from "lucide-react";
      ...
      <div className="px-5 pt-4 pb-6 space-y-4">
        ...
        {stage === "success" && (
          <>
            ...
            <Button className="w-full h-12 text-base font-extrabold" onClick={handleDone}>
              ✅ Done
            </Button>
          </>
        )}
        ...
        {stage === "error" && (
          <>
            <div className="flex flex-col items-center gap-3 py-4">
              ...
              <p className="text-base font-extrabold text-destructive">Upload failed</p>
