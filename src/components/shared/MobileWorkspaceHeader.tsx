...
const MobileWorkspaceHeader = ({
  ...
  <header
    className={`md:hidden sticky top-0 z-30 flex items-center gap-1.5 border-b border-border bg-card px-2 py-2 pt-[calc(0.5rem+env(safe-area-inset-top))] min-w-0 ${className}`}
  >
