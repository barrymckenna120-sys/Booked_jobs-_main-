...
const WorkspaceSwitchButton = ({ label, icon: Icon, onClick, className = "" }: WorkspaceSwitchButtonProps) => (
  <button
    ...
    className={`flex min-w-0 shrink items-center justify-center gap-1 rounded-lg border border-primary/40 bg-primary/5 px-2 min-h-[44px] max-w-full text-[12px] font-bold text-primary active:opacity-70 transition-colors ${className}`}
  >
