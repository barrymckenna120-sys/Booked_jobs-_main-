...
const WorkspaceIdentity = ({ label, icon: Icon }: WorkspaceIdentityProps) => (
  <div className="flex min-w-0 shrink items-center justify-center gap-1.5 rounded-lg border border-border bg-card px-2.5 min-h-[44px] max-w-full text-[14px] font-bold text-foreground">
