    ...
    <section className="section-container py-10">
      <div className="bg-gradient-to-br from-primary/5 via-background to-accent/10 rounded-3xl p-8 lg:p-12 border border-primary/10">
        ...
        <StaggerContainer className="grid sm:grid-cols-2 gap-4 max-w-3xl mx-auto">
          {features.map((f, i) => (
            <StaggerItem key={i}>
              <div className="flex items-center gap-4 bg-background/80 backdrop-blur-sm rounded-xl p-5 border border-border/60 shadow-sm hover:shadow-md hover:border-primary/20 transition-all duration-200">
