  ...
  return (
    <section className="section-container bg-secondary/30 rounded-2xl py-12">
      ...
      <div className="flex justify-center mb-8">
        <Badge className="bg-warning text-warning-foreground px-4 py-2 text-sm font-medium">
      ...
      <div className="bg-primary/10 rounded-xl p-6 mb-6">
        ...
        <p className="text-center text-3xl font-bold text-primary mb-4">€1,046 incl. VAT</p>
